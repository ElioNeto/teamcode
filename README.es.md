...
npm i -g teamcode-ai        # o bun/pnpm/yarn
scoop install teamcode             # Windows
choco install teamcode             # Windows
brew install teamcode/tap/teamcode # macOS y Linux (recomendado, siempre al día)
brew install teamcode              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S teamcode            # Arch Linux (Stable)
paru -S teamcode-bin               # Arch Linux (Latest from AUR)
mise use -g teamcode               # cualquier sistema
nix run nixpkgs#teamcode           # o github:teamcode/teamcode para la rama dev más reciente
```
...
TeamCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/teamcode/teamcode/releases) o desde [teamcode.ai/download](https://teamcode.ai/download).
...
1. `$TEAMCODE_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.teamcode/bin` - Alternativa por defecto
...
TeamCode incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://teamcode.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar TeamCode, [**ve a nuestra documentación**](https://teamcode.ai/docs).

### Contribuir

Si te interesa contribuir a TeamCode, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en TeamCode

Si estás trabajando en un proyecto basado en TeamCode y usas "teamcode" como parte del nombre, por ejemplo, "teamcode-dashboard" u "teamcode-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de TeamCode y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/teamcode) | [X.com](https://x.com/teamcode)
