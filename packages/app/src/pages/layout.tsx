...
import { ResizeHandle } from "@teamcode-ai/ui/resize-handle"
...
import { Session, type Message } from "@teamcode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@teamcode-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@teamcode-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://teamcode.ai/desktop-feedback")}
      renderPanel={() =>
