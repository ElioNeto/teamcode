export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by TeamCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in TeamCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.teamcodeZen.line1":
    "TeamCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.teamcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.teamcodeZen.visit.prefix": "Visit ",
  "provider.connect.teamcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.teamcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in TeamCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in TeamCode.",
  ...
  "dialog.server.description": "Switch which TeamCode server this app connects to.",
  ...
  "toast.update.description": "A new version of TeamCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the TeamCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, TeamCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "TeamCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the TeamCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for TeamCode",
  ...
  "settings.general.row.appearance.description": "Customise how TeamCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether TeamCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how TeamCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when TeamCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of TeamCode.",
