...
beforeAll(async () => {
  ...
  mock.module("@teamcode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@teamcode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@teamcode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@teamcode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
