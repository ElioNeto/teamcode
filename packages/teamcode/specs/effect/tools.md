...
Practical reference for the current tool-migration state in `packages/teamcode`.
...
Tool tests should use the existing Effect helpers in `packages/teamcode/test/lib/effect.ts`:
