...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders TEAMCODE_CALLER", () => {
    process.env["TEAMCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode TEAMCODE_CALLER", () => {
    process.env["TEAMCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown TEAMCODE_CALLER", () => {
    process.env["TEAMCODE_CALLER"] = "unknown"
