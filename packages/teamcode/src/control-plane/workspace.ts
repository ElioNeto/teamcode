...
export class Service extends Context.Service<Service, Interface>()("@teamcode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        TEAMCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        TEAMCODE_WORKSPACE_ID: config.id,
        TEAMCODE_EXPERIMENTAL_WORKSPACES: "true",
