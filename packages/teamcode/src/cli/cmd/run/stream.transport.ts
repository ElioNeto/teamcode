...
import type { Event, GlobalEvent, OpencodeClient } from "@teamcode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@teamcode/RunStreamTransport") {}
