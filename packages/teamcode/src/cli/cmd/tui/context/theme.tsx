...
import opencode from "./theme/teamcode.json" with { type: "json" }
...
import type { TuiThemeCurrent } from "@teamcode-ai/plugin/tui"
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    setStore(
      produce((draft) => {
        ...
        draft.mode = mode
        draft.lock = lock
        const active = config.theme ?? kv.get("theme", "teamcode")
        draft.active = typeof active === "string" ? active : "teamcode"
        draft.ready = false
      }),
    )
