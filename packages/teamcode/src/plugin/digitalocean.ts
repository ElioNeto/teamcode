import type { Hooks, PluginInput } from "@teamcode-ai/plugin"
import type { Model } from "@teamcode-ai/sdk/v2"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>TeamCode - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to TeamCode."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              ...
              instructions:
                "Sign in to DigitalOcean in your browser. TeamCode will create a Model Access Key named teamcode-oauth-* and load your Inference Routers. Re-run /connect to refresh routers later.",
