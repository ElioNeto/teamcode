...
export class Service extends Context.Service<Service, Interface>()("@teamcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __TEAMCODE_PHOTON_WASM_PATH?: string }).__TEAMCODE_PHOTON_WASM_PATH =
