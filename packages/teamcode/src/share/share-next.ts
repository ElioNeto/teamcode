import type * as SDK from "@teamcode-ai/sdk/v2"
...
const disabled = process.env["TEAMCODE_DISABLE_SHARE"] === "true" || process.env["TEAMCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@teamcode/ShareNext") {}
