...
import "@teamcode-ai/core/catalog"
import "@teamcode-ai/core/session-event"
...
export class Service extends Context.Service<Service, EventV2.Interface>()("@teamcode/EventV2Bridge") {}
