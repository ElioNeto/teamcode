...
Schema-first LLM core for teamcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@teamcode-ai/llm"
import { OpenAI } from "@teamcode-ai/llm/providers"
...
```ts
import { Anthropic } from "@teamcode-ai/llm/providers"
