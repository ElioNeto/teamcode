import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@teamcode-ai/sdk/v2"
import { SessionTurn } from "@teamcode-ai/ui/session-turn"
import { SessionReview } from "@teamcode-ai/ui/session-review"
import { DataProvider } from "@teamcode-ai/ui/context"
import { FileComponentProvider } from "@teamcode-ai/ui/context/file"
import { WorkerPoolProvider } from "@teamcode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@teamcode-ai/ui/logo"
import { IconButton } from "@teamcode-ai/ui/icon-button"
import { ProviderIcon } from "@teamcode-ai/ui/provider-icon"
import { iife } from "@teamcode-ai/core/util/iife"
...
import { MessageNav } from "@teamcode-ai/ui/message-nav"
import { FileSSR } from "@teamcode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@teamcode-ai/ui/pierre/worker").then((m) => ({
