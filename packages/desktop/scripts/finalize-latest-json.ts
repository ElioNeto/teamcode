...
const releaseId = process.env.TEAMCODE_RELEASE
if (!releaseId) throw new Error("TEAMCODE_RELEASE is required")
...
const macxTarGz = "teamcode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "teamcode-desktop-mac-arm64.app.tar.gz"
