...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    { role: "windowMenu" },
    {
      label: "Help",
      submenu: [
        { label: "TeamCode Documentation", click: () => shell.openExternal("https://teamcode.ai/docs") },
        { label: "Support Forum", click: () => shell.openExternal("https://github.com/ElioNeto/teamcode/discussions") },
        { type: "separator" },
        { type: "separator" },
        {
          label: "Share Feedback",
          click: () =>
            shell.openExternal("https://github.com/ElioNeto/teamcode/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/ElioNeto/teamcode/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
