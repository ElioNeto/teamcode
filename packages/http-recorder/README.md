...
Internal package; depended on as `@teamcode-ai/http-recorder` from another
workspace package.

```ts
import { HttpRecorder } from "@teamcode-ai/http-recorder"
```
...
```ts
import { HttpRecorder, Redactor } from "@teamcode-ai/http-recorder"
