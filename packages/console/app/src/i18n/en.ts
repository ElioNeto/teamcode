export const dict = {
  ...
  "enterprise.meta.description": "TeamCode Enterprise - AI-powered development for your organization",
  "enterprise.hero.title": "AI-Powered Development for Your Organization",
  "enterprise.hero.body1": "TeamCode Enterprise brings the power of AI-assisted coding to your entire organization with enhanced security, centralized management, and dedicated support.",
  "enterprise.hero.body2": "Get started with Enterprise today and transform how your team writes, reviews, and maintains code.",
  "enterprise.form.name.label": "Full Name",
  "enterprise.form.name.placeholder": "John Doe",
  "enterprise.form.role.label": "Job Title",
  "enterprise.form.role.placeholder": "Engineering Manager",
  "enterprise.form.company.label": "Company",
  "enterprise.form.company.placeholder": "Acme Inc.",
  "enterprise.form.email.label": "Work Email",
  "enterprise.form.email.placeholder": "john@acme.com",
  "enterprise.form.phone.label": "Phone Number",
  "enterprise.form.phone.placeholder": "+1 (555) 123-4567",
  "enterprise.form.message.label": "Message",
  "enterprise.form.message.placeholder": "Tell us about your team and what you're looking for...",
  "enterprise.form.send": "Send Request",
  "enterprise.form.sending": "Sending...",
  "enterprise.form.success": "Thank you! We'll be in touch soon.",
  "enterprise.form.success.submitted": "Your request has been submitted successfully.",
  "enterprise.form.error.allFieldsRequired": "All fields are required.",
  "enterprise.form.error.invalidEmailFormat": "Please enter a valid email address.",
  "enterprise.form.error.internalServer": "An error occurred. Please try again later.",
  "enterprise.faq.title": "Frequently Asked Questions",
  "enterprise.faq.q1": "What is included in the Enterprise plan?",
  "enterprise.faq.a1": "Enterprise includes unlimited seats, centralized billing, SSO/SAML, dedicated support, custom integrations, and priority feature requests.",
  "enterprise.faq.q2": "How does pricing work for Enterprise?",
  "enterprise.faq.a2": "Enterprise pricing is based on team size and specific needs. Contact our sales team for a custom quote.",
  "enterprise.faq.q3": "Can I try Enterprise before committing?",
  "enterprise.faq.a3": "Yes! We offer a 14-day free trial with full Enterprise features. No credit card required.",
  "enterprise.faq.q4": "How does SSO/SAML work?",
  "enterprise.faq.a4": "We support SAML 2.0 and OIDC-based SSO providers including Okta, Azure AD, Google Workspace, and more.",
