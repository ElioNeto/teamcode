...
brew install teamcode/tap/teamcode # macOS og Linux (anbefalet, altid up to date)
brew install teamcode              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
TeamCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/teamcode/teamcode/releases) eller [teamcode.ai/download](https://teamcode.ai/download).
...
1. `$TEAMCODE_INSTALL_DIR` - Tilpasset installationsmappe
...
TeamCode har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://teamcode.ai/docs/agents).

### Dokumentation

For mere info om konfiguration af TeamCode, [**se vores docs**](https://teamcode.ai/docs).

### Bidrag

Hvis du vil bidrage til TeamCode, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på TeamCode

Hvis du arbejder på et projekt der er relateret til TeamCode og bruger "teamcode" som en del af navnet; f.eks. "teamcode-dashboard" eller "teamcode-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af TeamCode-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/teamcode) | [X.com](https://x.com/teamcode)
