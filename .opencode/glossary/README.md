...
Use this folder for locale-specific translation guidance that supplements `.teamcode/agent/translator.md`.
...
- PR #12345: https://github.com/teamcode/teamcode/pull/12345

## Do Not Translate (Locale Additions)

- `TeamCode` (preserve casing)
